...
import Icon from '..';
var ThumbDownFilledIcon = forwardRef(function (props, ref) {
    var ariaLabel = props["aria-label"], rest = __rest(props, ['aria-label']);
    return (React.createElement(Icon, __assign({}, rest, { ref: ref }),
        React.createElement("svg", __assign({ "aria-label": "thumb down filled icon", viewBox: "0 0 24 24", role: 'img' }, (ariaLabel && { 'aria-label': ariaLabel })),
...
ThumbDownFilledIcon.colors = Icon.colors;
ThumbDownFilledIcon.sizes = Icon.sizes;
