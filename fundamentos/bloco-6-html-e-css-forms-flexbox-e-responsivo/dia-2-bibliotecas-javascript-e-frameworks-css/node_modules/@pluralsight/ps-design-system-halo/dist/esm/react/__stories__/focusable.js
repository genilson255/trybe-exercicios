...
var Focusable = function (props) {
    ...
    return (React.createElement("div", { style: __assign(__assign(__assign({}, styles.base), (themeName === themeNames.light ? styles.light : {})), (shape === vars.shapes.pill ? styles.pill : {})), tabIndex: 0 }, children));
};
